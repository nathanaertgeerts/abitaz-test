    ...
    <section aria-label="Top brands" className="container-abitaz mt-8">
      <div className="rounded-lg bg-surface p-4 md:p-5">
        <div className="mb-3 flex items-baseline justify-between">
          <h2 className="font-display text-base font-semibold md:text-lg">Shop by brand</h2>
          <Link to="/brands" className="whitespace-nowrap text-xs font-semibold text-primary hover:underline">
            All brands →
          </Link>
        </div>
