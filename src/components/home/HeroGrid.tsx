    ...
    <section aria-label="Featured collections" className="container-abitaz pt-4">
      ...
      <div className="md:hidden">
        <div
          ...
          className={`-mx-4 flex snap-x snap-mandatory gap-3 overflow-x-auto overscroll-x-contain rounded-lg px-4 pb-1 touch-pan-x select-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 [scroll-snap-stop:always] [-webkit-overflow-scrolling:touch] [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden ${
