...
export const sitemap: SitemapSection[] = [
  ...
  },
  {
    ...
    title: "My account",
    description:
      "Self-service hub. Drives repeat purchase & cuts support load. All routes require auth (guard TBD).",
    nodes: [
      { label: "Sign in", path: "/login", status: "skeleton" },
      { label: "Create account", path: "/register", status: "skeleton" },
      { label: "Forgot password", path: "/forgot-password", status: "skeleton" },
      ...
      { label: "Returns", path: "/account/returns", status: "skeleton" },
